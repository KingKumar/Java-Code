...
public abstract class SequenceTest {
    ...
    public final void testEntryAtTripleEntry() {
        ...
        assertEquals("<red,blue,green>", s.toString());
    ...
    public final void testNewInstanceEmpty() {
        Sequence<String> s1 = this.createFromArgs();
        Sequence<String> s2 = s1.newInstance();
    ...
    public final void testTransferFromNonEmpty() {
        Sequence<String> s1 = this.createFromArgs("red", "blue");
        Sequence<String> s2 = this.createFromArgs();
        s2.transferFrom(s1);
        assertEquals("<>", s1.toString());
